...
public class Dialogue {
    ...
    private String[] firstNight = {
            ...
            "Eventually, the darkness slowly fades away ... But the creepy feeling keeps on and prolongs throughout the night", //13
    };

    private String[] firstSeeNumber = {
            "You walk outside to see Rekt a.k.a your buddy standing right beside your post.",
            ...
            "\tYou decide to...? \n \t(0) Ask about the number \t (1) Tell your dream last night\n",
            "...\tRekt sees you with very confusing eyes. He thinks you haven't got yourself awake yet.",
            "...\n\tYou just prove your awkwardness within 5 seconds. Good job!\n\t# Abnormality went up by 2 #",
            ...
            "\t# Abnormality went up by 1 #",
            "...\tYou tell Rekt cautiously : 'It's like I'm still sleepy'. Immediately, he swings his big palm into your face.\n\tSwear to God you can even see stars now, but at least you don't get suspected.",
            "\t# Abnormality went down by 1 #\t# Stamina went down by A LOT #",
    };
    ...
    private String[] firstDeath = {
            ...
            "...\tWhat will you do now, going with him?\n \t(0) Nod and agree \t (1) Nope, stay away from the dead",
