...
public class Events {
    ...
    public void getEvent7B(Player player) {
        ...
        if (!isTriggered("7B") && isTriggered("5A")) {
            ...
            Player.say("While you are waiting, a phone rings from inside the store. Its soundâ€¦ Itâ€™s so peculiar, yet a bit similar. You have the feeling that you heard this somewhereâ€¦");
            setEventTrigger("7B");
            next();
        }
    }
    ...
    public void getEvent8A(Player player) {
        ...
        Player.say("Letâ€™s come to that Tattooistâ€™s place now, shall we?");
        setEventTrigger("8A");
        next();
    }
    ...
    public void getEvent15E(Player player) {
        ChoiceAction doChoiceAction = new ChoiceAction();
        if (isTriggered("15E")) {
            return;
        }
        printEvent(eventDial.getEvent15E());
        setEventTrigger("15E");
        next();
    }
